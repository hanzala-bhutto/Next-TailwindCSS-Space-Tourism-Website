...
export default function Crew() {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col justify-end gap-8">
          <h1 className={`uppercase text-3xl tracking-widest ${barlowCond.className}`}><span className="font-bold text-gray-600 mr-4">02</span> meet your crew</h1>
          <section className="w-full flex flex-row justify-between items-center mb-14">
